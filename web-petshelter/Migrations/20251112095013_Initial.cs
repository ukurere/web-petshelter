        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animals_Breeds_BreedId1",
                        column: x => x.BreedId1,
                        principalTable: "Breeds",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdopterName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    AdopterEmail = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskItems_Animals_AnimalId",
                        column: x => x.AnimalId,
                        principalTable: "Animals",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskItems_Shelters_ShelterId",
                        column: x => x.ShelterId,
                        principalTable: "Shelters",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_AnimalId",
                table: "TaskItems",
                column: "AnimalId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_AssigneeUserId_Status",
                table: "TaskItems",
                columns: new[] { "AssigneeUserId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_ShelterId",
                table: "TaskItems",
                column: "ShelterId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_Status_DueAt",
                table: "TaskItems",
